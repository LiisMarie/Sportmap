...
------------ | ------------- 
<img src="Pictures/tracking_ongoing.png" height="550px"> | <img src="Pictures/tracking_ongoing_landscape.png" width="550px">


Custom notification |
------------ |
<img src="Pictures/notification_lock_screen.png" width="300px"> |


Stopping tracking | Track after
------------ | -------------
<img src="Pictures/tracking_stopping.png" height="550px"> | <img src="Pictures/tracking_after.png" height="550px">


Menu | Settings 
------------ | ------------- 
<img src="Pictures/menu.png" height="550px"> | <img src="Pictures/settings.png" height="550px">


Account - logged in | Account - Register | Account - Login 
------------ | ------------- | -------------
<img src="Pictures/account.png" height="550px"> | <img src="Pictures/register.png" height="550px"> | <img src="Pictures/login.png" height="550px">


Sessions history - not logged in | Sessions history - logged in | Sessions history - logged in syncing
------------ | ------------- | -------------
<img src="Pictures/sessions_not_logged_in.png" height="550px"> | <img src="Pictures/sessions_logged_in_unsynced.png" height="550px"> | <img src="Pictures/sessions_logged_in_syncing.png" height="550px">
